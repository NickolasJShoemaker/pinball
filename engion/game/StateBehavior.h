...
class StateItem {
 public:
  ...
  constexpr int getUserProperty(){ return m_iUserProperty; }
  constexpr int getShapeProperty(){ return m_iShapeProperty; }
  constexpr bool getLight(){ return m_bLight; };
  constexpr int getSound(){ return m_iSound; };
  constexpr int getMusic(){ return m_iMusic; };
  constexpr int getDelay(){ return m_iDelay; };
  constexpr int getDelayState(){ return m_iDelayState; };
  constexpr int getCollState(){ return m_iCollState; };
  constexpr int getActSig(){ return m_iActSig; };
  constexpr int getCollSig(){ return m_iCollSig; };
  constexpr int getSigDelay(){ return m_iSigDelay; };
