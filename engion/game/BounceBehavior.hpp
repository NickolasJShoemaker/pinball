...
#ifndef BOUNCEBEHAVIOR_HPP
#define BOUNCEBEHAVIOR_HPP
...
public:
    BounceBehavior(int ball): Behavior(){
        m_iBall = ball;
        m_bAlive = false;
        m_vtxDir.x = 0.0;
        m_vtxDir.y = 0.0;
    ...
    * The upcomming direction may change, therefore we need to give the old direction. */
    ...
    void onCollision(const Vertex3D & vtx1, const Vertex3D & vtx2, Group* pGroup){
